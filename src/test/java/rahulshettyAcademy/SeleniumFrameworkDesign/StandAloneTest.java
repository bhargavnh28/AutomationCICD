...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("bhargavanh28@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Goutham@99");
		...
		//WebElement prod = products.stream().filter(product-> product.findElement(By.cssSelector("b")).getText().equals(productName2)).findFirst().orElse(null);
		//prod.findElement(By.cssSelector("button:last-of-type")).click();
		...
		//w.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[class=\"ta-results list-group ng-star-inserted\"]")));
